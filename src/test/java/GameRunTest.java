...
public class GameRunTest {
    ...
    /**
     * Test that the player get correct options for movement if standing on a normal model.tile,
     * not entrance.
     */
    @Test
    public void moveOptionOnTile() {
        for (int numPlayers = Configs.MIN_PLAYER; numPlayers <= Configs.MAX_PLAYER; numPlayers++) {
            ...
            for (Character c : Character.values()) {
                ...
                // put the player on a model.tile
    ...
    public void validMove() {
        for (int numPlayers = Configs.MIN_PLAYER; numPlayers <= Configs.MAX_PLAYER; numPlayers++) {
            ...
            // put the player on a boundary model.tile
    ...
    /**
     * Test that the model.game won't prompt options to let player go out of board.
     */
    @Test
