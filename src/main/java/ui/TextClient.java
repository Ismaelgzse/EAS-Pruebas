...
/**
 * A text based client for Cluedo. It use console to print out model.game board, and players use
 * console input to control the model.game process.
 * 
 * @author Hector
 *
 */
public class TextClient {
    ...
    public static void main(String[] args) {
        ...
        welcomeMsg();
        // set up the model.game, dealing model.card, joining players, etc.
        Game game = setupGame();
        // model.game running!
        runGame(game);
        // when model.game stops, some clean-up process.
        gameStop(game);
    ...
    /**
     * This function initialises the model.game, creates solutions, deals cards, and joins
     * players.
     * 
     * @return --- the initialised, running model.game
     */
    ...
    /**
     * This method represents a single step of model.game process. A single step means: system
     * prompt options to the player, and the player choose an option to act.
     * 
     * @param game
     *            --- the running model.game
     */
    private static void StepRun(Game game) {
        ...
        if (choice <= movablePos.size()) {
            ...
            if (destination instanceof Room) {
                ...
                // move to another model.tile, remainingSteps--
                remainingSteps--;
            }
    ...
    /**
     * This method ends the model.game, prompt the winner give players an option to restart a
     * new model.game.
     * 
     * @param game
     *            --- the running model.game
    ...
    private static void gameStop(Game game) {
        // TODO set model.game stop, prompt the winner
