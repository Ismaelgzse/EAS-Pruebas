...
/**
 * This enum class represents a character model.card in Cluedo model.game. There are six characters,
 ...
 * <br>
 * Note that this class is also used to symbolically represent the player in model.game.
 * 
 * @author Hector
 * 
 */
public enum Character implements Card {
     ...
     * It's useful for the model.game to know who the next acting character is.
     * 
