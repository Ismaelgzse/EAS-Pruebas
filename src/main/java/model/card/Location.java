...
/**
 * This enum class represents a Room model.card in Cluedo model.game. There are nine rooms, Kitchen,
 * Ball room, Conservatory, Billard Room, Library, Study, Hall, Lounge, and Dining
 * Room.<br>
 * <br>
 * Note that this class is also used to symbolically represent the Room position in model.game.
 * 
 * @author Hector
 *
 */
