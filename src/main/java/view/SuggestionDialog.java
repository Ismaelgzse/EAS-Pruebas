...
public class SuggestionDialog extends JDialog {
    /**
     * The preferred dimension for model.card displaying
     */
    ...
    private void addCharacterPanel(JPanel mainPanel) {
        ...
        // the middle panel to hold radio buttons and model.card display
