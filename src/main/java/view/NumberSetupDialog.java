...
public class NumberSetupDialog extends JDialog {
    ...
    /**
     * Construct a dialog to choose how many players and how many dices are used in model.game.
     * 
     * @param parent
    ...
    public NumberSetupDialog(GUIClient parent, Window windowForComponent, String string) {
        ...
        confirm.addActionListener(e -> {
            // if the player click OK, then we have a new model.game!
