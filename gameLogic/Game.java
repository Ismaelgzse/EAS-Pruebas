...
/**
 * This class represents a running Cluedo model.game.
 *
 * @author Hector
 *
 */
public class Game {
    ...
    /**
     * this map keep a record of who knows what model.card (that is not involved in crime)
     */
    ...
    /**
     * Construct the model.game.
     * 
     * @param numPlayers
     *            --- how many (human controlled) players are playing.
     * @param numDices
     *            --- how many dices are used in this model.game
     */
    ...
    public void creatSolution() {
        ...
        // then put the rest character cards in the model.card pile
        ...
        // then put the rest location cards in the model.card pile
    ...
    public void dealCard() {
        ...
        // let each player know what model.card he has, and what model.card remains undealt
        for (Player p : players) {
    ...
    /**
     * Check whether the given character has the given model.card in hand.
     * 
     * @param character
     *            --- the character
     * @param card
     ...
     * he/she can refute this suggestion with one model.card, or he/she can't.
     * 
     * @param suggestion
     *            --- the suggestion
    ...
    public String refuteSuggestion(Suggestion suggestion) {
        ...
        // shuffle so that it randomly reject the first refutable model.card
            ...
            if (p.getToken() != currentPlayer && !p.getCards().isEmpty()) {
                for (Card card : cardsInSuggetion) {
                    if (p.getCards().contains(card)) {
                        ...
                        continue outer; // only refute one model.card
                    }
                }
                rejectMsg = rejectMsg + p.getToken().toString()
    ...
    /**
     * Set the model.game to easy mode (so that the model.game will remember clues for player
     * ...cheating).
     * 
    ...
    /**
     * This method returns the ASCII, text-based model.game board as a String. On this board,
     * players' position, weapon's position are updated.
     * 
     * @return --- the text-based model.game board to print in console
     */
