...
/**
 * This class contains most of configurations to construct a model.game board. All fields and
...
public class Configs {
    /**
     * The number of dices used in model.game
     */
    ...
    /**
     * Maximum player to join into model.game.
     */
    public static final int MAX_PLAYER = 6;
    /**
     * the horizontal boundary coordinate of Cluedo model.game board.
     */
    public static final int BOARD_WIDTH = 24;
    /**
     * the vertical boundary coordinate of Cluedo model.game board.
     */
     ...
     *  represent one model.tile position, so that the ASCII board is not so skinny.<br>
     *  <br>
