...
public class PlayerPanelCanvas extends JPanel {
     ...
     * 
     * @param guiClient
     *            --- the Main GUI of this model.game
     */
     ...
     * 
     * @param cardImg
     *            --- the image used to display the model.card
     * @param example
     *            --- a Character or a Weapon or a Location model.card, as example. This
     *            argument is used to decide the type of this model.card, and look for
     *            appropriate image accordingly
     * @return --- a JLabel object to represents the model.card
     */
