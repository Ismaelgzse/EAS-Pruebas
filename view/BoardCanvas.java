...
public class BoardCanvas extends JPanel {
    ...
    /**
     * Construct a custom panel for display model.game board
     * 
     * @param guiClient
    ...
    public void update() {
        ...
        for (int i = 0; i < characterTokens.length; i++) {
            ...
            if (pos instanceof Tile) {
                ...
                // rectángulo rojo en el que se encuentra el personaje
                casillaRoja = new Rectangle(tile.x,tile.y,5,5);
    ...
    /**
     * The image used to display the model.game board
     */
