...
/**
 * This enum class represents a Weapon model.card in Cluedo model.game. There are six weapons,
 * Candlestick, Dagger, Lead Pipe, Revolver, Rope, and Spanner.<br>
 * <br>
 * Note that this class is also used to symbolically represent the weapon token in model.game.
 * 
 * @author Hector
 *
 */
