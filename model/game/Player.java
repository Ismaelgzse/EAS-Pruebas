...
/**
 * This class represents a player in Cluedo model.game. A player can either be a
...
public class Player {
    ...
    /**
     * cards drawn by this player. dummy token won't have any model.card in it.
     */
     ...
     *            -- its position
     * @param isPlaying
     *            --- whether this player is in model.game (human controllable)
     */
    ...
    /**
     * This method draws a model.card for this player.
     * 
     * @param card
     */
    ...
    /**
     * Examine whether this player has given model.card.
     * 
     * @param card
     *            --- the model.card to be examined
    ...
    /**
     * This method join current player into model.game (i.e. a player choosed this character)
     * 
     * @param isPlaying
