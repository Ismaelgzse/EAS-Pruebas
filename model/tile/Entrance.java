...
/**
 * This class represents a special type of Tile, which is the model.tile at the entrance of a
...
public class Entrance extends Tile {
    ...
    /**
     * The room that the player can enter from this entrance model.tile.
     */
    private Room toRoom;

    /**
     * Construct an entrance model.tile.
     * 
     * @param x
    ...
    /**
     * Get the room that the player can enter from this entrance model.tile.
     * 
     * @return --- The room that the player can enter from this entrance model.tile.
     */
    public Room toRoom() {
        return toRoom;
    }
